...
<details>
  ...
  ```{r dataset v3, message=FALSE, warning=FALSE,  results=FALSE, eval = TRUE}
  v3_mean <- as_tibble(
...
<details>
  ...
  ```{r ISBA data, message=FALSE, warning=FALSE,  results=FALSE, eval = TRUE}
...
```{r}
statsTable <- statsTab %>% filter(Year == 2008) %>%
